...
wine windeployqt --compiler-runtime --force ./build/install/opt/bin/librepcb.exe # Qt DLLs
wine windeployqt --compiler-runtime --force ./build/install/opt/bin/librepcb-cli.exe # Qt DLLs
